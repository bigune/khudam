...
Хөрвүүлэгч энэ ялгааг хэрэглэгчээс хэзээ ч нуухгүй: үр дүн бүр `verified` тэмдэглэгээтэй буцаагдана. Мөн нэг кирилл үг олон утгатай (олон бичлэгтэй) байж болох ба бүх хувилбаруудын хамт харуулна.
