...
> Khudam — an open-source Cyrillic ↔ traditional Mongolian script (монгол бичиг) lexicon and converter. *(English below.)*

**Худам монгол бичиг** бол уламжлалт монгол бичгийн сонгодог, түүхэн нэр юм. Энэ төсөл тэр нэрийг өвлөж авсан: зорилго нь монгол бичгийг дижитал орчинд хэн бүхэнд үнэгүй, нээлттэй, стандарт Юникодоор хүртээмжтэй болгох.
...
Khudam бол кирилл ↔ монгол бичиг хөрвүүлэлтийн **нээлттэй үгсийн сан** (lexicon) болон **хөрвүүлэх сан** (TypeScript library) юм.

- Бүх өгөгдөл энэ репод JSON хэлбэрээр хадгалагдана — Git бол бидний “мэдээллийн сан”. Сервер байхгүй, бүртгэл шаардахгүй, бүрэн үнэгүй.
- Хөрвүүлэгч нь хөтөч дээр шууд ажилладаг цэвэр TypeScript/JavaScript сан (`khudam` npm багц).
- Код нь MIT, өгөгдөл нь CC BY-SA 4.0 лицензтэй — хэн ч чөлөөтэй ашиглаж, сайжруулж болно, харин сайжруулсан хувилбар нь мөн нээлттэй байх ёстой.

### Даруухан анхааруулга

Бид дөнгөж эхэлж байна. Одоогийн үгсийн сангийн **дийлэнх нь машинаар үүсгэгдсэн, хүн шалгаагүй** өгөгдөл тул алдаа цөөнгүй бий. Энэ бол “бэлэн бүтээгдэхүүн” биш — хамт олноороо мөрөөрөө засаж баталгаажуулах **олон нийтийн төсөл** юм. Монгол бичиг мэддэг хүн бүрийн тусламж үнэтэй: [CONTRIBUTING.md](CONTRIBUTING.md)-г үзээрэй — програмчлал мэдэхгүй ч GitHub вэб дээрээс шууд засвар оруулж болно.

### Баталгаажсан ба баталгаажаагүй өгөгдөл

Үгсийн сангийн бичлэг бүр `verified` тэмдэгтэй:

- `"verified": true` — **хүн** шалгаж баталсан. Зөвхөн PR-ээр, хянагч хүний гараар тавигдана.
- `"verified": false` — машин импортын түвшний өгөгдөл. Алдаатай байж болно.

Хөрвүүлэгч энэ ялгааг хэрэглэгчээс хэзээ ч нуудаггүй: үр дүн бүр `verified` тэмдэгтэйгээ буцна. Мөн нэг кирилл үг олон утгатай (олон бичлэгтэй) байж болохыг бид нуудаггүй — бүх хувилбарыг жагсааж буцаана.

### Нэрсийн сан — эхний зорилт

`data/names.json` бол хүний нэрсийн тусгай сан. **Эхний том зорилт: нэрсийг 100% хүн баталгаажуулах.** Нэрээ монгол бичгээр зөв бичих нь хамгийн түгээмэл, хамгийн чухал хэрэгцээ учраас энд чанарыг бүрэн хангахыг зорьж байна. Одоогоор энэ файлд импортоос хуулсан, баталгаажаагүй цөөн жишээ л бий.
